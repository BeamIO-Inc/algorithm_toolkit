...
## Building the [atk](docker/atk/Dockerfile) Docker image
...
Visit [here](https://docs.docker.com/develop/develop-images/baseimages/) to learn more about base Docker images.

## Running the atk Docker image we just built (Optional)
...
## Building the [atk-dev](/docker/atk-dev/Dockerfile) Docker image

This build requires that you have already built the [atk](docker/atk/Dockerfile) Docker image in the previous steps.
...
This Docker image contains both the contents in the atk image, and [JupyterLab](https://jupyterlab.readthedocs.io/en/stable/getting_started/overview.html).

## Running the atk-dev Docker image we just built
...
## Recommendations for the atk-dev
